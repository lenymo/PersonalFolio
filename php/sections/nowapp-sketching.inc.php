				...
				<div class="container">
					<div class="grid">
						<div class="col-5-12 col-offset-1-12 text-left">
							...
							<p>
								Sketching is a crucial part of my work flow. I use the <a href="http://www.creativesoutfitter.com/product/34/dot-grid-book" title="Check out the Dot Grid Book." target="_blank">Behance Dot Grid Book</a>. Sketching helps me quickly iterate UI / UX concepts without the distractions of PhotoShop.
							</p>
							<p>
